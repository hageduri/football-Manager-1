        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-900">
                    ...
                    <form action="{{ url('test2_edit', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div style="padding: 10px;">
                            ...
                            <x-text-input  class="block mt-1 w-full" type="number" name="test2_id" value="{{ $data->test2_id }}" required autofocus autocomplete="shirt number" />                                    
                        ...
                        <div style="padding: 10px;">
                            ...
                            <select class="text-black" name="town">
                                <option class="text-black" value="{{$data->town }}">{{ $towndata[strval($data->town)-1]->name }}</option>
