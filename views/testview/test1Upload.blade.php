        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-600">
                            ...
                            <form action="{{ url('test1add') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div style="padding: 10px;">
                                    ...
                                    <x-text-input  class="block mt-1 w-full" type="number" name="test1_id" :value="old('test1_id')" required autofocus autocomplete="shirt number" />                                    
                                ...
                                <div style="padding: 10px;">
                                    ...
                                    {{-- <select class="text-black" name="gender">                                 --}}
                                        ...
                                        @foreach ($gendata as $row1)
                                            {{-- <option class="text-blue-500" value="{{ $row1->id }}">{{ $row1->name }}</option> --}}
                                ...
                                <div style="padding: 10px;">
                                    <x-input-label  for="position" :value="__('Position')"/>                                                                       
                                        ...
                                        @foreach ($posdata as $row3)
                                            {{-- <option class="text-blue-500" value="{{ $row3->id }}">{{ $row3->name }}</option> --}}
